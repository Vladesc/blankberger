...
GAME_RULES_CONTENT = ("Ziel des Spiels:\n"
                      "Das Ziel von 4-Gewinnt ist es, als erster Spieler vier seiner Spielsteine in eine waagerechte, senkrechte oder diagonale Reihe zu platzieren.\n"
                      "Spielbrett:\n"
                      ...
                      "Spielablauf:\n"
                      "Die Spieler setzen abwechselnd einen Spielstein in eine der leeren Spalten des Spielbretts. Die Spielsteine fallen immer bis zum untersten freien Feld in der ausgewählten Spalte.\n"
                      ...
                      "Das Spiel endet unentschieden, wenn das Spielbrett voll ist und keiner der Spieler vier Spielsteine in einer Reihe hat.\n"
                      "Spielmodi:\n"
                      ...
                      "Wir wünschen Ihnen nun viel Spaß und spannende Partien\n"
                      "bei unserem 4-Gewinnt-Spiel.")
